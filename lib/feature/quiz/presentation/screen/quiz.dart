...
class _QuizScreenState extends State<QuizScreen> {
      ...
      body: BlocBuilder<QuizCubit, QuizState>(
        builder: (context, state) {
          if (state is QuizLoading) {
            ...
            return _buildResultScreen(state.correctAnswers, state.totalQuestions);
          }
          return Center(
            child: ElevatedButton(
              onPressed: () {
  ...
  Widget _buildResultScreen(int correctAnswers, int totalQuestions) {
    return AlertDialog(
      title: AppText(data: AppStrings.quizResult),
      content: AppText(
          data: "${AppStrings.quizCorrAns} : $correctAnswers / $totalQuestions"),
      actions: [
        TextButton(
          onPressed: () => Get.back(),
